...
function draw_universe_map()
{
	...
	for (var i=0; i<sector_count; i++)
	{
		...
		if (sector_info[i]['mines'] == 1)
			sector_icons_html += ' <img src=\"./images/mine.gif\" style=\"width: 12px; height: 12px;\">';
		
		// check for pirate base
		if (sector_info[i]['pbase'] == 1)
			sector_icons_html += ' <img src=\"./images/pirate-base.gif\" style=\"width: 12px; height: 12px;\">';
		
		// check for shipyard
		if (sector_info[i]['syard'] == 1)
			sector_icons_html += ' <img src=\"./images/shipyard.gif\" style=\"width: 12px; height: 12px;\">';
		
		// check for equipment dock
		if (sector_info[i]['eq'] == 1)
			sector_icons_html += ' <img src=\"./images/equiptment-dock.gif\" style=\"width: 12px; height: 12px;\">';
